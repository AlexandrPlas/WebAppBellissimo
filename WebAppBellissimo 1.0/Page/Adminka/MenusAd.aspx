<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MenusAd.aspx.cs" Inherits="WebAppBellissimo_1._0.Page.Adminka.MenusAd" EnableEventValidation="false"%>
...
<div id="recept">
     <table>
            <tr>
                ...
                <td>
                    <h3><a class="add-btn" style="padding-left: 20px;text-decoration: none;font-family: Nautilus;" href="/Page/Adminka/NewMenusPage.aspx">Добавить</a></h3>
                </td>
            </tr>
        </table>
     ...
     <table class="alignmentR" style="font-size: 14pt; width: 70%; "border-collapse: collapse; border: 1px solid black;" border="1" cellpadding="5">
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                ...
                <tr>
                        <td>
                           <a class="Name_prod" href='/Page/MenuPage.aspx?MenuId=<%# Eval("MenuId") %>'><%# Eval("Name") %></a>
                        </td>
                        <td>
                        ...
                        <td>
                <ASP:Button  CssClass="yellowBtn"  CommandArgument='<%# Eval("MenuId") %>' Text="Удалить" runat="server" OnClick="Delete_Click" />
                        </td>
                    </tr>             
            ...
            <FooterTemplate>
                ...
                <div class="footer">
                    <%
                        ...
                        {
                            Response.Write(
                                String.Format("<a href='/Page/Adminka/MenusAd.aspx?page={0}' {1}>{2}</a>",
