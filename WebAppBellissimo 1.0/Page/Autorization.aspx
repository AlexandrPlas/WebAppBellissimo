<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Autorization.aspx.cs" Inherits="WebAppBellissimo_1._0.Page.Autorization" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="table">
        ...
        <asp:Button ID="OkButton" runat="server" Text="Войти" OnClick="OkButton_Click" />


        <br />
        <asp:Label ID="AutoOut" runat="server" Text=""></asp:Label>
    </div>
</asp:Content>
